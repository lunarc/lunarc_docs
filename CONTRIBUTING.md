...
<!-->Derived from UPPMAX CONTRIBUTING.md<-->
...
For ideas or feedback, create an [Issue](https://github.com/lunarc/lunarc_docs/issues).
These Issues will be discussed in a meeting and/or below that Issue.

Ideas that improve the experience of LUNARC users trying to use our resources will likely be accepted.

## Code

We welcome any contribution that:

- improves the experience of LUNARC users trying to use our resources
...
As an LUNARC contributor, one can contribute by:
...
Please contact us where to create new pages. 

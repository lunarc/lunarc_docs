...
[Introduction to Linux](linux/linux_basics_intro.md){ .md-button }

## Data transfer

How to move files between your local machine and COSMOS, and how to access long-term storage on Swestore.

[Transferring files overview](../getting_started/transferring_files.md){ .md-button }
...
[Containers guide](containers/apptainer.md){ .md-button }

## Specific applications

Guides for commonly used research software — Python, MATLAB, Mathematica, R, Abaqus, and COMSOL.

[Python](applications/Python.md){ .md-button }
[MATLAB](applications/MATLAB.md){ .md-button }
[R](applications/Rscript.md){ .md-button }
[COMSOL](applications/COMSOL.md){ .md-button }
[Mathematica](applications/Mathematica.md){ .md-button }
[Abaqus FEA](applications/Abaqus.md){ .md-button }

## Batch system

Additional guidance on using specific node types and partitions.

[Using the 32-core nodes](batch_system/32_core_nodes.md){ .md-button }
